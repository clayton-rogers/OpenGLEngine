...
std::string Mesh::replaceStrChar(std::string str, const std::string& replace, char ch) {
...
const std::vector<GLfloat> Mesh::loadObject(std::string path) {
...
void Mesh::Draw(GLuint program, glm::mat4 model, glm::vec3 colour, GLfloat shininess) const {
